...
typedef struct ms_NoteEvent
{
    ...
    double _tempo;
    enum ms_NoteArticulation _articulation;
} ms_NoteEvent;
...
typedef int (* ms_MuseSampler_is_ranged_articulation)(enum ms_NoteArticulation);
typedef ms_Result (* ms_MuseSampler_add_track_event_range_start)(ms_MuseSampler, ms_Track, int voice, enum ms_NoteArticulation);
typedef ms_Result (* ms_MuseSampler_add_track_event_range_end)(ms_MuseSampler, ms_Track, int voice, enum ms_NoteArticulation);
